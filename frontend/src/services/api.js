...
export const API_BASE = process.env.REACT_APP_API_URL || 'https://restaurant-discovery-platform-production.up.railway.app';
...
export const reviewAPI = {
  ...
  replyToReview: (id, reply) => api.put(`/reviews/${id}/owner-reply`, { reply }),
