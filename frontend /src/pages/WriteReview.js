  ...
  if (user?.role === 'owner') {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Review posting is disabled for owners</h1>
        <p className="text-gray-600 mb-6">Owners can manage restaurants and reply to user reviews from the dashboard.</p>
        <button
          type="button"
          onClick={() => navigate('/owner/dashboard')}
          className="bg-yelp-red text-white px-6 py-2 rounded-lg font-semibold hover:bg-yelp-dark transition"
        >
